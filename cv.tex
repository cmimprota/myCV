...
\header{Costanza Maria }{Improta}
       {UK's Top 10 Computer Science Undergraduate of 2018}
...
\begin{entrylist}
  \entry
    ...
    \begin{itemize}
        \item FYP - a Dense Captioning approach to generate a Descriptive Paragraph of an image.
        \item Enjoyed ML, Symbolic AI (with NLP), Computer Graphics and Image Processing.
        \item Strong interest in Data Science, Deep Learning, Web Development and Graphics.
...
\begin{entrylist}
  \entry
    ...
    \begin{itemize}
        ...
        \item Developed an interactive simulation tool to display and analyse air traffic.
...
\begin{aside}
  ...
  \bigskip
  \href{http://www.unilink.it/workshop-arduino/}{Arduino and the IoT}
  \href{https://www.meetup.com/Recast-AI-Developers-Meetup/events/241170842/}{From NLP theory to chatbots}
  ~
...
\entry
    ...
    \begin{itemize}
        \item I manage PASS for 300+ first year students and their second year leaders.
        \item I lead and run debrief sessions for second year PASS leaders to help them develop and improve their mentoring sessions.
        \item This improves organizational, communication and public speaking skills.\\
    \end{itemize}
\begin{entrylist}
  \entry
    {}
...
\entry
    ...
    \begin{itemize}
        \item I organise events aiming to bring students and tech industry closer together.\\
    \end{itemize}
   \entry
    {}
  ...
  \entry
    ...
    \begin{itemize}
        ...
        \item Minute all the transactions the society carries out and plot down budgets.
